...
const carouselCards = [
  {
    id: 1,
    category: "Komunikasi Mahasiswa-Dosen",
    title: "Kolaborasi mulus antara mahasiswa dan pembimbing",
    icon: ArrowRight,
    mockup: "intercom",
  },
  {
    id: 2,
    category: "Pelacakan Penelitian",
    title: "Pantau progres melalui semua fase penelitian",
    icon: Plus,
    mockup: "github",
  },
  {
    ...
    title: "Akses penelitian Anda kapan saja, di mana saja",
    icon: ArrowRight,
    mockup: "mobile",
  },
  {
    ...
    title: "Timeline terintegrasi sesuai persyaratan kelulusan",
    icon: ArrowRight,
    mockup: "asks",
  },
  {
    id: 5,
    category: "Integrasi Perpustakaan",
    title: "Terhubung dengan database dan sumber akademik",
    icon: ArrowRight,
    mockup: "integrations",
  },
  {
    id: 6,
    category: "Kolaborasi Dokumen",
    title: "Kolaborasi dokumen thesis real-time",
    icon: ArrowRight,
    mockup: "figma",
  },
  {
    id: 7,
    category: "Alur Kerja Khusus",
    title: "Bangun proses dan alur kerja spesifik universitas",
    icon: ArrowRight,
    mockup: "api",
  },
]
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
          <div className="lg:max-w-xl">
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-sm text-zinc-400">Alat & Fitur Terintegrasi</span>
            ...
            <h2 className="text-4xl md:text-5xl font-medium text-white leading-[1.1]">
              Hubungkan seluruh
              <br />
              ekosistem akademik Anda
            </h2>
          </div>

          {/* Description */}
          <p className="text-zinc-400 lg:max-w-sm lg:pt-12">
            Sentra terintegrasi dengan alat dan sistem akademik yang ada, menciptakan platform terpadu yang membuat mahasiswa, 
            pembimbing, dan staf administrasi tetap terhubung mulus selama proses penelitian.
          </p>
        </div>
