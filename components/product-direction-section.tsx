    ...
    <section className="relative py-40 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-zinc-400 text-sm">Timeline Penelitian & Milestone</span>
        ...
        >
          Rencanakan dan lacak kemajuan penelitian
        </h2>

        {/* Description */}
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">Timeline terpadu untuk milestone penelitian.</span> Dari proposal penelitian hingga pertahanan, 
          lacak semua fase kritis dengan alat perencanaan dan visualisasi komprehensif Sentra.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          {/* Left column - Manage research end-to-end */}
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Manage research end-to-end</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Consolidate research plans, literature reviews, methodologies, and thesis milestones in one centralized location.
            </p>

            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              <h4 className="text-lg font-medium text-zinc-200 mb-5">Research Overview</h4>
          ...
          {/* Right column - Research updates */}
          <div className="border-t border-b border-zinc-800 pt-10 pl-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Research progress updates</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Communicate research progress and dissertation health with built-in status updates and milestone tracking.
            </p>
            ...
            <div className="relative h-48">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-green-500 font-medium text-sm">On Schedule</span>
                </div>
                <p className="text-zinc-300 text-sm mb-3">Literature review completed and approved by advisor</p>
                <span className="text-zinc-500 text-xs">Next: Methodology Design</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="border-r border-zinc-800 pt-16 pr-10 pb-16 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-zinc-200 font-medium">Real-time collaboration</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-green-500/50" />
                <span className="text-zinc-400">Advisor feedback inline</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-green-500/30" />
                <span className="text-zinc-500">Version history & suggestions</span>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 overflow-hidden">
              ...
              <div className="p-5">
                ...
                <div className="mb-3 relative inline-block">
                  <span className="text-zinc-200 text-lg font-medium">Research</span>
                  <span className="relative mx-1">
                    <span className="text-zinc-200 text-lg font-medium bg-green-500/20 px-0.5">Framework</span>
                ...
                <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                  Document your research questions and collaborate on{" "}
                  <span className="relative inline">
                    <span className="bg-purple-500/20 px-0.5">method</span>
                    <span className="absolute -bottom-4 left-0 px-1.5 py-0.5 rounded text-[10px] bg-purple-600 text-white">
                      Student
                    </span>
                  </span>
                  ology design in realtime, multiplayer thesis documents. Include **structure** and ##chapters with rich-text
                  formatting and advisor comments.
                </p>
